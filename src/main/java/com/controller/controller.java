...
//    @PreAuthorize("hasRole('ROLE_ADMIN') and  hasPermission(#Posts,'createpost')")
//    @RequestMapping(value = "/addPost", method = RequestMethod.POST)
//    public ModelAndView addPost(@Valid @ModelAttribute("Posts") Posts Posts, BindingResult bindingResult) {
//
...
//////        System.out.println(post.getName()+ "     "+post.getDate());
////        postService.AddPost(Posts);
////        System.out.println("after *****************************");
//
//        ModelAndView modelAndView = new ModelAndView("post");
//        modelAndView.addObject("message", "Done Add Post ......");
//
//        return modelAndView;
